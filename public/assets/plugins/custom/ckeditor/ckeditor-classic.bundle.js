    ...
    return function (t) {
        ...
        class Vu extends Dl {
            ...
            updatePosition() {
                if (this.numberOfPanels) {
                    const {top: t, left: e} = this._balloonPanelView, {width: n, height: i} = new As(this._balloonPanelView.element);
        ...
        class Hm extends Kl {
            ...
            init() {
                ...
                this._enableAutomaticDecorators(n.filter(t => t.mode === Bm)), this._enableManualDecorators(n.filter(t => t.mode === Fm)), function ({view: t, model: e, emitter: n, attribute: i, locale: o}) {
            ...
            _getMergeableCell() {
                ...
                const e = this.editor.plugins.get("TableUtils"), n = this.isHorizontal ? function (t, e, n) {
                    ...
                    const a = parseInt(t.getAttribute("rowspan") || 1), c = "down" == e ? o + a : o,
                        l = [...new ap(i, {endRow: c})], d = l.find(e => e.cell === t).column,
                        h = l.find(({row: t, rowspan: n, column: i}) => i === d && ("down" == e ? t === c : c === t + n));
                    return h && h.cell
                }(t, this.direction);
                if (!n) return;
            ...
            execute() {
                ...
                t.change(t => {
                    ...
                    r.filter(({row: t, rowspan: e}) => t === i && e > 1).forEach(({column: t, cell: e, rowspan: n}) => s.set(t, {
                        cell: e,
                        rowspanToSet: n - 1
                    })), r.filter(({row: t, rowspan: e}) => t <= i - 1 && t + e > i).forEach(({cell: e, rowspan: n}) => np("rowspan", n - 1, e, t));
        ...
        class Rp extends ed {
            ...
            execute() {
                ...
                t.change(t => {
                    ...
                    for (const {cell: e, column: n, colspan: i} of s) n <= a && i > 1 && n + i > a ? np("colspan", i - 1, e, t) : n === a && t.remove(e)
                })
            }
        }
        ...
        function Lp(t, e, n) {
            ...
            let u;
            for (const {row: e, column: i, cell: r, cellIndex: a} of h) if (r === t && void 0 === u && (u = i), void 0 !== u && u === i && e === d) {
