        ...
        <div class="subheader py-2 py-lg-6  subheader-transparent " id="kt_subheader">
            <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Actions-->
                    <a href="{{route('payment.index')}}" class="btn  font-weight-bolder btn-sm">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <!--begin::Form-->
                    <form
                        action="{{ (isset($payment))?route('payment.update',$payment->journal_id):route('payment.store')}}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-5">
                                            <select
                                                ...
                                                <option
                                                    value="C" {{(isset($payment) && $payment->transaction_type=='C')?'selected':old('C')}}>
                                                    Cash
                                                </option>

                                                <option
                                                    value="B" {{(isset($payment) && $payment->transaction_type=='B')?'selected':old('B')}}>
                                                    Bank
                                                </option>
                                            </select>
                                        ...
                                        <div class="col-lg-5">
                                            <div class="input-group date">
                                                <input type="text" class="form-control
                                                       ...
                                                       name="date"
                                                       value="{{ !empty(old('date'))?old('date'):(!empty($payment->date)?date('d-m-Y',strtotime($payment->date)):date('d-m-Y')) }}"
                                                       id="kt_datepicker_3"/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-5">
                                            <input type="number" name="grand_total"
                                                   ...
                                                   placeholder="0.00"
                                                   value="{{(isset($payment))?$payment->grand_total:old('grand_total')}}">
                                            @error('grand_total')
                                            <div class="invalid-feedback" role="alert">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                                <textarea name="description" placeholder="Description"
                                                          class="form-control "> {{(isset($payment))?$payment->description:old('description')}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
