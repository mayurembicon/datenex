                        ...
                        <div class="card card-custom">
                            ...
                            <div class="card-header py-3">
                                <div class="card-title align-items-start flex-column">
                                    ...
                                    <span class="text-muted font-weight-bold font-size-sm mt-1">Change Company Profile</span>
                                </div>
                            ...
                            <i class="ki ki-bold-close icon-xs text-muted"></i>
                                                ...
                                                <div class="form-group row">
                                                    <label
                                                        class="col-form-label col-3 text-lg-right text-left">Address 2</label>
                                                    <div class="col-9">
                                                        <input class="form-control "
                                                               type="text"
                                                               name="address2"
                                                ...
                                                <div class="form-group row">
                                                    <label
                                                        class="col-form-label col-3 text-lg-right text-left">Address 3</label>
                                                    <div class="col-9">
                                                        <input class="form-control "
                                                               type="text"
                                                               name="address3"
                                                        ...
                                                        <select
                                                            ...
                                                            @if(!empty($companyInfo))
                                                                <option
                                                                    ...
                                                                    {{ isset($companyInfo->getcountry)?$companyInfo->getcountry->country_name:''}}
                                                                </option>
                                                            @endif
                                                        </select>
                                                    </div>
                                                        ...
                                                        <select
                                                            ...
                                                            @if(!empty($companyInfo))
                                                                <option
                                                                    ...
                                                                    {{ isset($companyInfo->getstate)?$companyInfo->getstate->state_name:''}}
                                                                </option>
                                                            @endif
                                                        </select>
                                                    </div>
