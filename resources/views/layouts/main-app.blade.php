...
<!--begin::Page Vendors Styles(used by this page)-->
    <link href="{{env('ASSET_URL').'assets/plugins/custom/fullcalendar/fullcalendar.bundle.css'}}" rel="stylesheet"
          type="text/css"/>
    <!--end::Page Vendors Styles-->


    <!--begin::Global Theme Styles(used by all pages)-->
    <link href="{{env('ASSET_URL').'assets/plugins/global/plugins.bundle.css'}}" rel="stylesheet" type="text/css"/>
    <link href="{{env('ASSET_URL').'assets/plugins/custom/prismjs/prismjs.bundle.css'}}" rel="stylesheet"
          type="text/css"/>
...
<div id="kt_header_mobile" class="header-mobile align-items-center  header-mobile-fixed ">
    <!--begin::Logo-->
    <a href="{{url('/')}}">
        <img alt="Logo" src="{{env('ASSET_URL').'assets/media/logos/logo-letter-1.png'}}"
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path
            ...
            fill="#000000" opacity="0.3"/>
                        ...
                        <li class="menu-item  menu-item-submenu {{ (request()->is('tenant*')||
request()->is('financial-year*')||
request()->is('customer*') ||
request()->is('item-master*')   )  ? 'menu-item-open' : '' }}"
            ...
            fill="#000000" opacity="0.3"/>
                            ...
                            <div class="menu-submenu "><i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item menu-item-submenu {{ request()->is('tenant*') ? 'menu-item-active' : '' }}"
                                        aria-haspopup="true"
...
<script src="{{env('ASSET_URL').'assets/plugins/custom/fullcalendar/fullcalendar.bundle.js'}}"></script>
<!--end::Page Vendors-->
