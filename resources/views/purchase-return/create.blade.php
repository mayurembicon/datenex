        ...
        <div class="subheader py-2 py-lg-6  subheader-transparent " id="kt_subheader">
            <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Actions-->
                    <a href="{{route('purchase-return.index')}}" class="btn  font-weight-bolder btn-sm">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <!--begin::Form-->
                        <form
                            action="{{ (isset($purchaseReturn))?route('purchase-return.update',$purchaseReturn->purchase_return_id):route('purchase-return.store')}}"
                            method="post">
                            @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <select
                                                            ...
                                                            @if(!empty($purchaseReturn))
                                                                <option
                                                                    value="{{(isset($purchaseReturn))?$purchaseReturn->customer_id:(old('customer_id')?old('customer_id'):0)}}">
                                                                    {{ isset($purchaseReturn->getcustomer)?$purchaseReturn->getcustomer->company_name:''}}
                                                                </option>
                                                            @endif
                                                        </select>
                                        ...
                                        <strong>{{ $errors->first('customer_id') }}</strong>
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-4 col-form-label">Original Purchase No<span
                                                            class="text-danger">*</span></label>
                                                    <div class="col-lg-4">
                                                        <input type="text" name="original_purchase_no"
                                                               class="form-control{{ $errors->has('original_purchase_no') ? ' is-invalid' : '' }}"
                                                               placeholder="Original Purchase No" autocomplete="off"
                                                               value="{{(isset($purchaseReturn))?$purchaseReturn->original_purchase_no:old('original_purchase_no')}}">
                                                        @if ($errors->has('original_purchase_no'))
                                                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('original_purchase_no') }}</strong>
                                    </span>
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-4 col-form-label">Original Purchase Date</label>
                                                    <div class="col-lg-4">
                                                        <div class="input-group date">
                                                            <input type="text"
                                                                   name="original_purchase_date" autocomplete="off"
                                                                   class="form-control  @error('original_purchase_date') is-invalid @enderror"
                                                                   placeholder="dd-mm-yyyy"
                                                                   id="kt_datepicker_3"
                                                                   value="{{(isset($purchaseReturn))?date('d-m-Y',strtotime($purchaseReturn->original_purchase_date)):old('original_purchase_date')}}">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-4 col-form-label">Purchase Return Date</label>
                                                    <div class="col-lg-4">
                                                        <div class="input-group date">
                                                            <input type="text"
                                                                   name="purchase_return_date" autocomplete="off"
                                                                   class="form-control  @error('purchase_return_date') is-invalid @enderror"
                                                                   placeholder="dd-mm-yyyy"
                                                                   id="kt_datepicker_3"
                                                                   value="{{(isset($purchaseReturn))?date('d-m-Y',strtotime($purchaseReturn->purchase_return_date)):old('purchase_return_date')}}">
                                                            <div class="input-group-append">
															<span class="input-group-text">
																<i class="la la-calendar"></i>
															</span>
                                                            </div>
                                                            @error('purchase_return_date')
                                                            <div class="invalid-feedback"
                                                                 role="alert">{{ $message }}</div>
                                                            @enderror
                                                        </div>
							...
							<label>
									...
									<span></span>
                                        ...
                                        <div class="shipping k-section" style="display: none">
                                            <div class="k-section__body">
                                                <h3 class="k-section__title k-section__title-lg">Shipping
                                                    Address:</h3>
                                                <div class="form-group row">
                                                    <label class="col-4 col-form-label">Country</label>
                                                    <div class="col-lg-6">
                                    ...
                                    <div id="kt_repeater_1">
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-sm">
                                                ...
                                                <div class="k-repeater-grid-items">
                                                    @php $gridItem=!empty(old('grid_items'))?old('grid_items'):(empty($purchaseitems)?[]:$purchaseitems);
$i=0;
                                                    @endphp
                                                    @if(!$gridItem)
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-2 ">
                                                <input type="text" name="total" readonly
                                                       ...
                                                       placeholder=""
                                                       value="{{(isset($purchaseReturn))?$purchaseReturn->total:old('total')}}">
                                                @error('total')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-2 ">
                                                <input type="text" name="pf"
                                                       ...
                                                       placeholder=""
                                                       value="{{(isset($purchaseReturn))?$purchaseReturn->pf:old('pf')}}">
                                                @error('pf')
                                                <div class="invalid-feedback" role="alert">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-lg-2 ">
                                                <select
                                                    ...
                                                    @foreach($taxrate  as $item)
                                                        <option
                                                            value="{{$item->tax_rate}}" {{(isset($purchaseReturn) &&  $purchaseReturn->pf_taxrate==$item->tax_rate)?'selected':''}}
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-2">
                                                <input type="text" name="total_with_pf" readonly
                                                       ...
                                                       placeholder=""
                                                       value="{{(isset($purchaseReturn))?$purchaseReturn->total_with_pf:old('total_with_pf')}}">
                                                @error('total_with_pf')
                                                <div class="invalid-feedback" role="alert">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <input type="number" step="any"
                                                    ...
                                                    @error('rounding_amount') is-invalid @enderror " id="rounding"
                                                       value="{{(isset($purchaseReturn))?$purchaseReturn->rounding_amount:old('rounding_amount')}}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-2 ">
                                                <input type="text" name="grand_total" readonly
                                                       ...
                                                       value="{{(isset($purchaseReturn))?$purchaseReturn->grand_total:old('grand_total')}}">
                                                @error('grand_total')
                                                <div class="invalid-feedback" role="alert">{{ $message }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <textarea name="notes" id="notes"
                                                      class=" form-control">{{(isset($purchaseReturn))?$purchaseReturn->notes:old('notes')}}</textarea>
                                        </div>
                                    </div>
...
@push('scripts')
    ...
    <script>
        $("#auto_invoice_no").change(function () {
            if (this.checked) {
                $("#invoice_div").hide();
            } else {
                $("#invoice_div").show();
    ...
    <script>
        $(document).ready(function () {
            $("#switch1").change(function () {
                ...
                if (this.checked) {
                    $(".dtdeteils").show();
                    $(".dtdeteils :input").attr("enabled", true);
                } else {
                    $(".dtdeteils").hide();
                    $(".dtdeteils :input").attr("disabled", false);
                }
            });
            @if(!empty($purchaseReturn->docket_transport_deteils) && $purchaseReturn->docket_transport_deteils =='Y')
            $("#switch1").prop('checked', true);
            @endif

            @if(!empty($purchaseReturn->docket_transport_deteils) && $purchaseReturn->docket_transport_deteils =='N')
            $("#switch1").prop('checked', false);
            @endif

            @if(!empty(old('docket_transport_deteils')) && old('docket_transport_deteils')=='on')
            $("#switch1").prop('checked', true);
            @endif

            @if(!empty($purchaseReturn->docket_transport_deteils) || !empty(old('docket_transport_deteils')))
