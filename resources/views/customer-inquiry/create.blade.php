...
<!--begin::Page Vendors Styles(used by this page)-->
    <link href="{{env('ASSET_URL','http://localhost/datenex/public/').'assets/plugins/custom/fullcalendar/fullcalendar.bundle.css'}}" rel="stylesheet"
          type="text/css"/>
    ...
    <link href="{{env('ASSET_URL','http://localhost/datenex/public/').'assets/plugins/custom/prismjs/prismjs.bundle.css'}}" rel="stylesheet"
          type="text/css"/>
    ...
    <link href="{{env('ASSET_URL','http://localhost/datenex/public/').'assets/css/themes/layout/header/base/light.css'}}" rel="stylesheet"
          type="text/css"/>
    <link href="{{env('ASSET_URL','http://localhost/datenex/public/').'assets/css/themes/layout/header/menu/light.css'}}" rel="stylesheet"
          type="text/css"/>
    <link href="{{env('ASSET_URL','http://localhost/datenex/public/').'assets/css/themes/layout/brand/light.css'}}" rel="stylesheet" type="text/css"/>
    <link href="{{env('ASSET_URL','http://localhost/datenex/public/').'assets/css/themes/layout/aside/dark.css'}}" rel="stylesheet" type="text/css"/>

    <!--end::Layout Themes-->
    <link rel="shortcut icon" href="{{env('ASSET_URL','http://localhost/datenex/public/').'assets/media/logos/favicon.ico'}}"/>
</head>
...
<div class="page-loader page-loader-logo">
    <img alt="Logo" class="max-h-75px" src="{{env('ASSET_URL','http://localhost/datenex/public/').'assets/media/logos/logo-letter-4.png'}}"/>
    <div class="spinner spinner-primary"></div>
</div>
<div id="kt_header_mobile" class="header-mobile align-items-center  header-mobile-fixed ">
    <!--begin::Logo-->
    <a href="{{url('/')}}">
        <img alt="Logo" src="{{env('ASSET_URL','http://localhost/datenex/public/').'assets/media/logos/logo-letter-1.png'}}"
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path
            ...
            fill="#000000"/>
		                ...
		                <span class="svg-icon svg-icon-xl svg-icon-primary"><!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg--><svg
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
        ...
        <path
            ...
            fill="#000000" opacity="0.3"/>
					  ...
					  <span class="svg-icon svg-icon-xl svg-icon-primary"><!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Group-chat.svg--><svg
                              xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                              height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
                            ...
                            <div class="container-fluid">
                                ...
                                <span class="example-copy" data-toggle="tooltip" title=""
                                      data-original-title="Copy code"></span>
                                            ...
                                            <form
                                                action="{{ (isset($customerinquiry))?route('customer-inquiry.update',$customerinquiry->customer_inquiry_id):route('customer-inquiry.store')}}"
                                                method="post" id="my-form">
                                                @csrf
                                                @if(isset($customerinquiry))
                                                    @method('PUT')
                                                @endif
                                                <div class="card-body">


                                                    <div class="pb-5 font-size-h4-lg">Inquiry Info:</div>


                                                    <div class="form-group row">

                                                        <div class="col-3">
                                                            <label class="col-5 col-form-label">Company Name<span
                                                                    class="text-danger">*</span></label>
                                                            <div class="input-group">
                                                                <input type="text" name="company_name"
                                                                       placeholder="Company Name"
                                                                       class="client-clr form-control form-control-sm {{ $errors->has('company_name') ? ' is-invalid' : '' }}"
                                                                       value="{{(isset($customerinquiry))?$customerinquiry->company_name:old('company_name')}}">
                                        ...
                                        <strong>{{ $errors->first('company_name') }}</strong>
                                                        ...
                                                        <div class="col-3">
                                                            <label class="col-5 col-form-label">Contact Person</label>

                                                            <input type="text" name="contact_person"
                                                                   class="form-control form-control-sm  {{ $errors->has('contact_person') ? ' is-invalid' : '' }}"
                                                                   placeholder="Contact Person"
                                                                   value="{{(isset($customerinquiry))?$customerinquiry->contact_person:old('contact_person')}}">
                                        ...
                                        <strong>{{ $errors->first('contact_person') }}</strong>
                                                        ...
                                                        <div class="col-3">
                                                            <label class="col-5 col-form-label">Phone No <span
                                                                    class="text-danger">*</span></label>
                                                            ...
                                                            <input type="text" name="phone_no" id="phone_no"
                                                                   ...
                                                                   class=" form-control client-clr form-control-sm {{ $errors->has('phone_no') ? ' is-invalid' : '' }}"
                                                                   value="{{(isset($customerinquiry))?$customerinquiry->phone_no:old('phone_no')}}">
                                        ...
                                        <strong>{{ $errors->first('phone_no') }}</strong>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-3">
                                                            ...
                                                            <input type="email" name="email" id="email"
                                                                   ...
                                                                   class=" form-control client-clr form-control-sm"
                                                                   value="{{(isset($customerinquiry))?$customerinquiry->email:old('email')}}">
                                                        ...
                                                        <div class="col-3">
                                                            ...
                                                            <input type="text" name="subject"
                                                                   ...
                                                                   value="{{(isset($customerinquiry))?$customerinquiry->subject:old('subject')}}">
                                                    ...
                                                    <div class="pb-5 font-size-h4-lg">Product Details:</div>
                                                    ...
                                                    <div id="kt_repeater_1">
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered table-sm">
                                                                ...
                                                                @php $gridItem=!empty(old('grid_items'))?old('grid_items'):(empty($customerinquiryitems)?[]:$customerinquiryitems);
                                                                    ...
                                                                    <tr data-repeater-item="">
                                                                        ...
                                                                        <td class="p-0" width="20%">
                                                                            ...
                                                                            <input type="text" name="item_name"
                                                                                   ...
                                                                                   class="form-control grid-item {{ $errors->has('item_name') ? ' is-invalid' : '' }}"
                                                                                   autocomplete="off">
                                                                ...
                                                                <strong>{{ $errors->first('item_name') }}</strong>
                                                                        ...
                                                                        <td class="p-0" width="10%">
                                                                            <input type="number"
                                                                                   class="form-control grid-item @error('qty') is-invalid @enderror"
                                                                                   autocomplete="off"
                                                                                   name="qty"
                                                                                   value="{{ isset($values['qty'])?$values['qty']:0}}"
                                                                                   placeholder="1"/>
                                                                ...
                                                                @else
                                                                    @php $i=0; @endphp
                                                                    @foreach($gridItem as $key=>$values)

                                                                        <tr data-repeater-item="">
                                                                            <td class="p-0" width="20%">

                                                                                <input type="text"
                                                                                       class="form-control grid-item @error('item_name') is-invalid @enderror"
                                                                                       name="item_name"
                                                                                       placeholder="Select Item"

                                                                                       value="{{ isset($values['item_name'])?$values['item_name']:""}}">
                                                                                @if ($errors->has('grid_items.'.$i.'.item_name'))
                                                                                    <span class="invalid-feedback"
                                                                                          role="alert">
                                                                        <strong>{{ $errors->first('grid_items.'.$i.'.item_name') }}</strong>
                                                                        </span>
                                                                                @endif
                                                                            ...
                                                                            <td class="p-0" width="20%">
                                                                                <input type="text"
                                                                                       ...
                                                                                       autocomplete="off"
                                                                                       name="p_description"
                                                                                       value="{{ isset($values['p_description'])?$values['p_description']:""}}">
                                                                            </td>
                                                                            <td class="p-0" width="10%">
                                                                                <input type="number"
                                                                                       class="form-control grid-item @error('qty') is-invalid @enderror"
                                                        ...
                                                        <div class="form-group row ">
                                                            ...
                                                            <div class="col-lg-4">
                                                                <a href="javascript:;" data-repeater-create=""
                                                                   class="btn btn-sm font-weight-bolder btn-light-primary create-new-item">
                                            ...
                                            <textarea name="notes" rows="3"
                                                      class="form-control">{{(isset($customerinquiry))?$customerinquiry->notes:old('notes')}}</textarea>
                                                            </div>
                                                        </div>
...
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="navi navi-spacer-x-0 p-0">
            <!--begin::Item-->
            <a href="{{asset('custom/apps/user/profile-1/personal-information.html')}}" class="navi-item">
                <div class="navi-link">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <circle fill="#000000" opacity="0.3" cx="18.5" cy="5.5" r="2.5"/>
            ...
            <!--begin::Item-->
            <a href="{{asset('custom/apps/user/profile-3.html')}}" class="navi-item">
                <div class="navi-link">
                    <div class="symbol symbol-40 bg-light mr-3">
                        <div class="symbol-label">
...
<script src="{{env('ASSET_URL','http://localhost/datenex/public/').'assets/plugins/custom/fullcalendar/fullcalendar.bundle.js'}}"></script>
...
<script src="{{env('ASSET_URL','http://localhost/datenex/public/').'assets/js/pages/crud/forms/widgets/bootstrap-touchspin.js'}}"></script>
<script
...
<script
    src="{{env('ASSET_URL','http://localhost/datenex/public/').'assets/js/pages/crud/forms/widgets/form-repeater.js?v=7.0.4'}}"></script>
<script>
    ...
    $(document).on('click', ".create-new-itemmaster", function () {
        setTimeout(function () {
            console.log('cli');
            $('.select2-control').select2({
                placeholder: "Select ...",
    ...
    calculateGridItemTotal = function (target) {
        ...
        var taxrate = parseFloat(jQuery('select[name="taxrate"]').val());
        pf = isNaN(pf) ? 0 : pf;
        taxrate = isNaN(taxrate) ? 0 : taxrate;
        var pfgstrate = ((pf * taxrate) / 100);
    ...
    calculateGridValues = function (target) {
        ...
        if (matches) {
            ...
            var taxRateName = "grid_items[" + gridRowID + "][gst_rate]";
    ...
    $(document).on('change', "select.itemmaster-clr", function () {
        ...
        var saleRateName = item_id.replace('item_id', 'sale_rate');
