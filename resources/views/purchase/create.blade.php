        ...
        <div class="subheader py-2 py-lg-6  subheader-transparent " id="kt_subheader">
            <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Actions-->
                    <a href="{{route('purchase.index')}}" class="btn  font-weight-bolder btn-sm">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <form
                            action="{{ ($TY=='U')?route('purchase.update',$purchase->purchase_id):route('purchase.store')}}"
                            ...
                            <input type="hidden" name="po_id" value="{{(isset($purchase->po_id))?$purchase->po_id:''}}">
                            <div class="card-body">
                                <div class="mb-1">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <select
                                                ...
                                                @if(!empty($purchase))
                                                    <option
                                                        value="{{(isset($purchase))?$purchase->customer_id:(old('customer_id')?old('customer_id'):0)}}">
                                                        {{ isset($purchase->customer)?$purchase->customer->company_name:''}}
                                                    </option>
                                                @endif
                                            </select>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <input type="text" name="bill_no"
                                                   ...
                                                   value="{{(isset($purchase))?$purchase->bill_no:old('bill_no')}}">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <input type="text" name="order_no"
                                                   ...
                                                   value="{{(isset($purchase))?$purchase->order_no:old('order_no')}}">
                                            @error('order_no')
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="input-group date">
                                                <input type="text" name="bill_date"
                                                       ...
                                                       id="kt_datepicker_3"
                                                       value="{{ !empty(old('bill_date'))?old('bill_date'):(!empty($purchase->bill_date)?date('d-m-Y',strtotime($purchase->bill_date)):date('d-m-Y')) }}">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="input-group date">
                                                <input type="text"
                                                       ...
                                                       placeholder="dd-mm-yyyy"
                                                       id="kt_datepicker_3"
                                                       value="{{(isset($purchase))?date('d-m-Y',strtotime($purchase->due_date)):old('due_date')}}">
                                                <div class="input-group-append">
															<span class="input-group-text">
																<i class="la la-calendar"></i>
															</span>
                                    ...
                                    <div id="kt_repeater_1">
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-sm">
                                                ...
                                                @php $gridItem=!empty(old('grid_items'))?old('grid_items'):(empty($purchaseproduct)?[]:$purchaseproduct);
                                                ...
                                                @if(!$gridItem)
                                                    <tr data-repeater-item="">
                                                        ...
                                                        <td class="p-0" width="20%">
                                                            ...
                                                            <select
                                                                class="form-control grid-item item-select2  item-clr {{ $errors->has('grid_items.'.$i.'.item_id') ? ' is-invalid' : '' }}"
                                                                name="item_id">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-2 ">
                                                <input type="text" name="total" readonly
                                                       ...
                                                       placeholder=""
                                                       value="{{(isset($purchase))?$purchase->total:old('total')}}">
                                                @error('total')
                                                <div class="invalid-feedback" role="alert">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-2 ">
                                                <input type="text" name="pf"
                                                       ...
                                                       placeholder=""
                                                       value="{{(isset($purchase))?$purchase->pf:old('pf')}}">
                                                @error('pf')
                                                <div class="invalid-feedback" role="alert">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-lg-2 ">
                                                <select
                                                    ...
                                                    @foreach($taxrate  as $item)
                                                        <option
                                                            value="{{$item->tax_rate}}" {{(isset($purchase) &&  $purchase->pf_taxrate==$item->tax_rate)?'selected':''}}
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-2">
                                                <input type="text" name="total_with_pf" readonly
                                                       ...
                                                       placeholder=""
                                                       value="{{(isset($purchase))?$purchase->total_with_pf:old('total_with_pf')}}">
                                                @error('total_with_pf')
                                                <div class="invalid-feedback" role="alert">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <input type="number" step="any"
                                                    ...
                                                    @error('rounding_amount') is-invalid @enderror " id="rounding"
                                                       value="{{(isset($purchase))?$purchase->rounding_amount:old('rounding_amount')}}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-2 ">
                                                <input type="text" name="grand_total" readonly
                                                       ...
                                                       value="{{(isset($purchase))?$purchase->grand_total:old('grand_total')}}">
                                                @error('grand_total')
                                                <div class="invalid-feedback" role="alert">{{ $message }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <select
                                                ...
                                                <option
                                                    value="" {{(isset($purchase))?$purchase->payment_terms_id:old('payment_terms_id ')}}>
                                                    select
                                                </option>
                                                @foreach($payment as $key)
                                                    <option
                                                        value="{{$key->payment_terms_id}}" {{(isset($purchase) &&  $purchase->payment_terms_id==$key->payment_terms_id)?'selected':''}}
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <textarea name="notes" id="notes"
                                                      class=" form-control ">{{(isset($purchase))?$purchase->notes:old('notes')}}</textarea>
                                        </div>
                                    </div>
...
@push('scripts')
    ...
    <script>
        $(document).on('change', "select.item-clr", function () {
            ...
            var PuchaseRateName = item_id.replace('item_id', 'rate');
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("input[name='" + PuchaseRateName + "']").val(data.purchase_rate);
