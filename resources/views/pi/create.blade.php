        ...
        <div class="subheader py-2 py-lg-6  subheader-transparent " id="kt_subheader">
            <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Actions-->
                    <a href="{{route('pi.index')}}" class="btn  font-weight-bolder btn-sm">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <!--begin::Form-->
                        <form
                            action="{{ ($TY=='U')?route('pi.update',$pi->pi_id):route('pi.store')}}"
                            ...
                            <input type="hidden" name="quotation_id"
                                   value="{{(isset($pi->quotation_id))?$pi->quotation_id:''}}">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <select
                                                            ...
                                                            @if(!empty($pi))
                                                                <option
                                                                    value="{{(isset($pi))?$pi->customer_id:(old('customer_id')?old('customer_id'):0)}}">
                                                                    {{ isset($pi->customer)?$pi->customer->company_name:''}}
                                                                </option>
                                                                @endif
                                                        </select>
                                        ...
                                        <strong>{{ $errors->first('customer_id') }}</strong>
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-4 col-form-label">Pi Date</label>
                                                    <div class="col-lg-4">

                                                        <div class="input-group date">
                                                            <input type="text" name="pi_date"
                                                                   class="form-control  @error('pi_date') is-invalid @enderror"
                                                                   autocomplete="off"
                                                                   placeholder="dd-mm-yyyy"
                                                                   id="kt_datepicker_3"
                                                                   value="{{ !empty(old('pi_date'))?old('pi_date'):(!empty($pi->pi_date)?date('d-m-Y',strtotime($pi->pi_date)):date('d-m-Y')) }}">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <div class="input-group date">
                                                            <input type="text"
                                                                   ...
                                                                   placeholder="dd-mm-yyyy"
                                                                   id="kt_datepicker_3"
                                                                   value="{{ !empty(old('due_date'))?old('due_date'):(!empty($pi->due_date)?date('d-m-Y',strtotime($pi->due_date)):date('d-m-Y')) }}">
                                                            <div class="input-group-append">
															<span class="input-group-text">
																<i class="la la-calendar"></i>
															</span>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input type="text" name="order_no"
                                                               ...
                                                               value="{{(isset($pi))?$pi->order_no:old('order_no')}}">
                                                        @error('order_no')
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input type="text" name="ref_order_no"
                                                               ...
                                                               value="{{(isset($pi))?$pi->ref_order_no:old('ref_order_no')}}">
                                                        @error('ref_order_no')
                                                        <div class="invalid-feedback" role="alert">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <div class="input-group date">
                                                            <input type="text"
                                                                   ...
                                                                   placeholder="dd-mm-yyyy"
                                                                   id="kt_datepicker_3"
                                                                   value="{{ !empty(old('ref_order_date'))?old('ref_order_date'):(!empty($pi->ref_order_date)?date('d-m-Y',strtotime($pi->ref_order_date)):date('d-m-Y')) }}">
                                                            <div class="input-group-append">
															<span class="input-group-text">
																<i class="la la-calendar"></i>
															</span>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="email"
                                                               ...
                                                               value="{{(isset($pi))?$pi->email:old('email')}}">
                                                        @error('email')
                                                        <div class="invalid-feedback" role="alert">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-4 col-form-label">Pi Person</label>
                                                    <div class="col-lg-6">
                                                        <input type="text"
                                                               name="pi_person" autocomplete="off"
                                                               class="form-control  @error('pi_person') is-invalid @enderror"
                                                               placeholder="Pi Person"
                                                               value="{{(isset($pi))?$pi->pi_person:old('pi_person')}}">
                                                        @error('pi_person')
                                                        <div class="invalid-feedback" role="alert">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                    ...
                                    <div id="kt_repeater_1">
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-sm">
                                                ...
                                                @php $gridItem=!empty(old('grid_items'))?old('grid_items'):(empty($piitems)?[]:$piitems);
                                              $i=0; @endphp
                                                @if(!$gridItem)
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-2">
                                                <input type="text" name="total" readonly
                                                       ...
                                                       placeholder=""
                                                       value="{{(isset($pi))?$pi->total:old('total')}}">
                                                @error('total')
                                                <div class="invalid-feedback" role="alert">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-2 ">
                                                <select
                                                    ...
                                                    @foreach($taxrate  as $item)
                                                        <option
                                                            value="{{$item->tax_rate}}" {{(isset($pi) &&  $pi->pf_taxrate==$item->tax_rate)?'selected':''}}
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-2">
                                                <input type="text" name="total_with_pf" readonly
                                                       ...
                                                       placeholder=""
                                                       value="{{(isset($pi))?$pi->total_with_pf:old('total_with_pf')}}">
                                                @error('total_with_pf')
                                                <div class="invalid-feedback" role="alert">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-2">
                                                <input type="number" step="any"
                                                       ...
                                                       value="{{(isset($pi))?$pi->rounding_amount:old('rounding_amount')}}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-2">
                                                <input type="text" name="grand_total" readonly
                                                       ...
                                                       placeholder=" "
                                                       value="{{(isset($pi))?$pi->grand_total:old('grand_total')}}">
                                                @error('grand_total')
                                                <div class="invalid-feedback" role="alert">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <select
                                                    class="form-control  placeofsupply-select2  @error('place_of_supply') is-invalid @enderror"
                                                    name="place_of_supply"
                                                    id="place_of_supply">
                                                    @if(!empty($transportdeteils))
                                                        <option
                                                            value="{{(isset($transportdeteils))?$transportdeteils->place_of_supply:(old('place_of_supply')?old('place_of_supply'):0)}}">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-4">
                                                ...
                                                <select
                                                    ...
                                                    <option
                                                        value="" {{(isset($pi))?$pi->payment_terms_id:old('payment_terms_id ')}}>
                                                        select
                                                    </option>
                                                    @foreach($payment as $key)
                                                        <option
                                                            value="{{$key->payment_terms_id}}" {{(isset($pi) &&  $pi->payment_terms_id==$key->payment_terms_id)?'selected':''}}
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <textarea name="notes" id="notes"
                                                          class=" form-control ">{{(isset($pi))?$pi->notes:old('notes')}}</textarea>
                                            </div>
                                        </div>
                                    </div>
