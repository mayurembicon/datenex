            ...
            <div class="row">
                <div class="col-lg-8 text-center">
                    <div class="card card-custom gutter-b example example-compact ">
                        ...
                        <!--begin::Form-->
                        <form action="{{route('itemwise-sp.store')}}" method="post">
                            @csrf
                                        ...
                                        <div class="col-9 col-form-label">
                                            <div class="radio-inline">
                                                ...
                                                <label class="radio  col-form-label">
                                                    ...
                                                    value="sales_wise" {{(!empty($selectedItem))&& ($selectedItem == 'sales_wise')?'checked':'' }}/><span></span>ItemWise Sales

                                                </label>
                                                <label class="radio  col-form-label">
                                                    <input type="radio" id="purchase_wise" name="item"  @error('purchase_id') checked @enderror
                                                    value="purchase_wise" {{(!empty($selectedItem))&& ($selectedItem == 'purchase_wise')?'checked':'' }}/><span></span>ItemWise Purchase
                                        ...
                                        <div class="col-lg-6">
                                            <select
                                                ...
                                                @foreach($item as $key=>$value)
                                                    <option
                                                        value="{{$value->item_id}}" {{(isset($salesID) &&  in_array($value->item_id,$salesID))?'selected':''}}>{{$value->name}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div id="PurchaseWise" style="display: none" class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <select
                                                ...
                                                @foreach($item as $key=>$value)
                                                    <option
                                                        value="{{$value->item_id}}" {{(isset($purchaseID) &&  in_array($value->item_id,$purchaseID))?'selected':''}}>{{$value->name}}</option>
                                                @endforeach
                                            </select>
                                            @error('purchase_id')
                                            <div class="invalid-feedback">{{ $message }}</div>
