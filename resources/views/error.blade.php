...
<head>
    ...
    <link href="{{env('ASSET_URL','http://localhost/datenex/public/').'assets/css/pages/error/error-6.css'}}" rel="stylesheet" type="text/css"/>
    ...
    <link href="{{env('ASSET_URL','http://localhost/datenex/public/').'assets/css/themes/layout/header/base/light.css'}}" rel="stylesheet" type="text/css"/>
    <link href="{{env('ASSET_URL','http://localhost/datenex/public/').'assets/css/themes/layout/header/menu/light.css'}}" rel="stylesheet" type="text/css"/>
    <link href="{{env('ASSET_URL','http://localhost/datenex/public/').'assets/css/themes/layout/brand/dark.css'}}" rel="stylesheet" type="text/css"/>
    <link href="{{env('ASSET_URL','http://localhost/datenex/public/').'assets/css/themes/layout/aside/dark.css'}}" rel="stylesheet" type="text/css"/>        <!--end::Layout Themes-->
...
<div class="d-flex flex-column flex-root">
    <!--begin::Error-->
    <div class="error error-6 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url({{env('ASSET_URL','http://localhost/datenex/public/').'assets/media/error/bg6.jpg'}});">
        <!--begin::Content-->
