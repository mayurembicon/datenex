        ...
        <div class="subheader py-2 py-lg-6  subheader-transparent " id="kt_subheader">
            <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Actions-->
                    <a href="{{route('sales-return.create')}}" class="btn btn-light-primary font-weight-bolder btn-sm">
        ...
        <!--begin::Notice-->
            ...
            <div class="card card-custom">
                <div class="card-body" style="padding:1px 10px;!important;">
                    <form action="{{ url('search-sr') }}" method="POST" role="search">
                        {{ csrf_field() }}
                        <div class="form-group row">
                            ...
                            <div class="col-lg-2">
                                <label class="col-form-label ">Original Invoice No</label>
                                <select
                                    class="item-clr form-control @error('item_id') is-invalid @enderror "
                                    id="original_invoice_no"
                                    name="original_invoice_no">
                                    <?php if(!empty($selectedOriginalInvoiceNo)){ ?>
                                    <option
                                        value="<?php echo $selectedOriginalInvoiceNo; ?>"><?php echo $selectedOriginalInvoiceNo; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        ...
                        <table class="table table-bordered table-hover table-checkable mt-11 col-form-label">
                            ...
                            @foreach($salesReturn as $key=>$value)
                                <tr>
                                    ...
                                    <td>{{isset($value->invoice_no)?$value->invoice_no:$value->original_invoice_no}}</td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('sales-return.edit',$value->sales_return_id)}}"
                                           class="btn btn-warning btn-sm"><i class="fa fa-edit"></i>
                                        </a>

                                    <td>

                                        <form action="{{route('sales-return.destroy',$value->sales_return_id) }}"
                                              method="post">
                                            @csrf @method('DELETE')
            ...
            ajax: {
                ...
                data: function (params) {
                    return {
                        ...
                        field_name: 'original_invoice_no'
                    };
                }, processResults: function (response) {
                    return {results: response};
                }, cache: true
