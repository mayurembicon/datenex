        ...
        <div class="subheader py-2 py-lg-6  subheader-transparent " id="kt_subheader">
            <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a href="{{route('receipt.create')}}" class="btn btn-light-primary font-weight-bolder btn-sm">
        ...
        @include('layouts.flash-message')
            ...
            <div class="card card-custom">
                ...
                <div class="card-body" style="padding:1px 10px;!important;">
                    <form action="{{ url('search-rc')}}" method="POST" role="search">
                        {{ csrf_field() }}
                            ...
                            @foreach($receipt as $key=>$value)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route ('receipt.edit',$value->journal_id)}}"
                                           class="btn btn-warning btn-sm">
                                            <i class="fa fa-edit"></i> </a>

                                    <td>

                                        <form action="{{route('receipt.destroy',$value->journal_id)}}" method="post">
                                            @csrf
                                            @method('DELETE')
